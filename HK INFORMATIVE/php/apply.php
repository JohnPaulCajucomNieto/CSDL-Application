...
<script>
    function sumbit(){
        alert ("HK Application for scholarship has been submitted successfully, I will contact you if your application is qualified! ")
    }
</script>
<body>
    ...
    <div id="content">
        ...
        <div  id="right">
            ...
            <form method="post" action="../php/insert.php" onsubmit="sumbit()">
                ...
                <br>
                <input type="date" id="_day" name="birthday" style="width: 655px;"required >
                <br>
                ...
                <br>
                <input type="text" id="num" name="age" placeholder="ex:18" style="width: 655px;" required>
                <br>
                

                <label for="phone">Facebook Link</label>
                <br>
                <input type="text" id="num" name="facebook_link" placeholder="" style="width: 655px;" required>
                <br>
